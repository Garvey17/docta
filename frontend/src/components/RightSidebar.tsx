...
import { LayoutDashboard, Camera, ClipboardCheck, Database, ShieldCheck } from 'lucide-react';
...
export function RightSidebar({ currentScreen, onNavigate, hasActiveReview = false }: RightSidebarProps) {
  return (
