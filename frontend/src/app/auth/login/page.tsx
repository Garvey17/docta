    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl max-w-md w-full border border-gray-200 shadow-xl p-8 relative">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">Sign in to docta</h1>
        ...
        <div className="mt-5 text-center">
          <Link href="/auth/signup" className="text-xs text-indigo-600 hover:text-indigo-700 font-semibold">
